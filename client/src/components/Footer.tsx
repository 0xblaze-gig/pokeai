export default function Footer() {
  ...
  const resources = [
    { name: "Whitepaper", href: "#tokenomics" },
    { name: "Documentation", href: "#roadmap" },
    { name: "Smart Contract", href: "#roadmap" },
    { name: "Audit Report", href: "#roadmap" },
    { name: "Media Kit", href: "#roadmap" }
  ];
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a target="_blank" href="https://x.com/@PokeAionSOL" className="text-gray-400 hover:text-primary transition-colors duration-300">
          ...
          <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-black">Quick Links</h3>
          ...
          <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-black">Resources</h3>
            <ul className="space-y-3">
          ...
          {/* <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-black">Subscribe</h3>
